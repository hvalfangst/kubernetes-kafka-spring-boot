...
import hvalfangst.kafka.security.JwtTokenFilter
import hvalfangst.kafka.service.UserDetailsServiceImpl
...
class ApplicationSecurity {
    ...
    fun filterChain(http: HttpSecurity): SecurityFilterChain {
        http.authorizeHttpRequests {
            ...
            it.requestMatchers("/api/kafka/**").hasAnyAuthority("ADMIN")
